...
install_done () {
    ...
    echo_with_color ${Yellow} "=============================================================================="
    echo_with_color ${Yellow} "==    Check https://gist.github.com/saifulapm/8ef9aade24b171ea204559165f663851      =="
    echo_with_color ${Yellow} "=============================================================================="
    echo_with_color ${Yellow} ""
    echo_with_color ${Yellow} "That's it. Thanks for installing. Enjoy!"
    echo_with_color ${Yellow} ""
}
